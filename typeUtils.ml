...
let rec split_variant_type name t = match unAlias t with
...
let rec project_type name t = match unAlias t with
...
let rec erase_type name t = match unAlias t with
...
let rec element_type t = match unAlias t with
