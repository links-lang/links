...
type 'a expression' =
  ...
  | Xml_text of string * 'a
  | Xml_element of (string * (string * 'a expression') list * 'a expression' list * 'a)
  | Xml_identity of ('a expression' * 'a) (* Should appear only temporary during type-inference... *)
  | Record_empty of 'a
  ...
  | Xml_concat of ('a expression' * 'a expression' * 'a)
  ...
  | PatternHasType of ('a expression' * Types.datatype * 'a)
