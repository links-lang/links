...
let%expect_test "Module nesting allows partially-qualified names to be used for resolution" =
  ...
  [%expect {|
    exit: 1
    ***: Module Error: Could not find file ./tests/modules/basic-partial-qualification.links |}]
