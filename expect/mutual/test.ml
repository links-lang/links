...
let%expect_test "Use structural unification if nominal unification fails (type error)" =
  ...
  [%expect {| exit: 1***: Module Error: Could not find file ./tests/mutual/structural2.links |}]
