...
class map =
  object ((o : 'self_type))
    ...
    method phrasenode : phrasenode -> phrasenode =
      ...
      | `Data _x -> let _x = o#phrase _x in `Data _x
    ...
    method fieldconstraint : fieldconstraint -> fieldconstraint =
      ...
      | `Readonly -> `Readonly
      | `Default -> `Default
      | `Prov _x -> let _x = o#option (fun o -> o#phrase) _x in `Prov _x
...
class fold =
  object ((o : 'self_type))
    ...
    method fieldconstraint : fieldconstraint -> 'self_type =
      ...
      | `Readonly -> o
      | `Default -> o
      | `Prov _x -> let o = o#option (fun o -> o#phrase) _x in o
...
class fold_map =
  object ((o : 'self_type))
    ...
    method phrasenode : phrasenode -> ('self_type * phrasenode) =
      ...
      | `Data _x -> let (o, _x) = o#phrase _x in (o, (`Data _x))
    ...
    method fieldconstraint :
      ...
      | `Readonly -> (o, `Readonly)
      | `Default -> (o, `Default)
      | `Prov _x -> let (o, _x) = o#option (fun o -> o#phrase) _x in (o, `Prov _x)
