...
(* OASIS_START *)
(* DO NOT EDIT (digest: 59740b2749783725c1a5c7a7b7fbb9a6) *)
(*
...
let setup_t =
  {
            ...
            [
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/links-lang/links.git";
                      src_repo_browser =
                        Some "https://github.com/links-lang/links";
                      src_repo_module = None;
                      src_repo_branch = Some "sessions";
                      src_repo_tag = None;
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable PostgreSQL database backend";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Enable MySQL database backend";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Enable SQLite database backend";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable SQLite3 database backend";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Enable MonetDB database backend";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("deriving.syntax.classes", None);
                           FindlibPackage ("deriving.runtime", None);
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pg_database"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "links";
                      lib_findlib_name = Some "postgres";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Mysql_database"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "links";
                      lib_findlib_name = Some "mysql";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "links-sqlite";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Lite_database"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "links";
                      lib_findlib_name = Some "sqlite";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "links-sqlite3";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["M5_database"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "links";
                      lib_findlib_name = Some "monetdb";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "links"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                      ...
                      bs_c_sources = [];
                      bs_data_files = [("prelude.links", None)];
                      bs_findlib_extra_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      bs_cclib = [(OASISExpr.EBool true, [])];
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "links.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\225\219\149d\152\131\204<u_\134\228N\171\130\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
