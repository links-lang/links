        ...
        return Object.freeze({
            ...
            'canReceiveMessage': function(v) {
                ...
                for (let i = 0; i < containedSessions.length; i++) {
                    const ep2id = containedSessions[i]._sessEP2;
                    if (!buffers[ep2id]) return false;
                }
                return true;
            },
            ...
            'commitChannel': function(epid, lostMessages) {
                ...
                if (orphans == null) orphans = [];
                buffers[epid] = orphans.concat(lostMessages, origBuf);
                pendingEndpoints[epid] = null;
            ...
            'prepareDelegatedChannels': function(chans) {
                ...
                //
                // Side-effects:
                //   * buffers[<recv port>] will be deleted.
                //   * delegating[<recv port>] will be set to [].
                const res = [];
