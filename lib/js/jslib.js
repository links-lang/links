    ...
    */
    ...
    fieldVal: function (name) {
      ...
      for (let i = 0; i < forms.length; ++i) {
        ...
        // TODO(dhil): I think this might be a bug. I think it should
        // read '_formkey' rather than 'formkey' as the latter is not
        // in scope. Chances are this function might not be called by
        // any of our examples/code in the wild. Thus it could be dead
        // code.
        if (key === formkey) {
