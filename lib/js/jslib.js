...
const newClientAP = LINKS.kify(_newClientAP);
const newServerAP = LINKS.kify(_newServerAP);
const newAP = LINKS.kify(_newAP);
...
const ttData = LINKS.kify(_ttData);
const ttFrom = LINKS.kify(_ttFrom);
const ttTo = LINKS.kify(_ttTo);
const vtData = LINKS.kify(_vtData);
const vtFrom = LINKS.kify(_vtFrom);
const vtTo = LINKS.kify(_vtTo);
