...
var LINKS = function() {
  ...
  function resolveMobileProcesses(state, processes) {
  ...
  var _remoteCallHandler = function (kappa, request, synch) {
    return function() {
      if (request.readyState == AJAX.isComplete && !request.finished) {
       ...
       var state = {mobilePids: {}};

       resolveMobileProcesses(state, serverResponse.content.state);
...
function _spawn(f) {
  ...
  _spawnWithMessages(childPid, f, messages);
}
