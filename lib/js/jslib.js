...
function _debugChl(msg) {
  _debug($str(msg));
}
var debug = LINKS.kify(_debugChl, 1);  // This is undesirable:
                                       // We use _debug for a JS-level debug,
                                       // which takes a JS string,
                                       // but the Links-level debug takes
                                       // a Links string (charlist)
...
var isAlpha = LINKS.kify(_isAlpha, 1);
var isAlnum = LINKS.kify(_isAlnum, 1);
var isLower = LINKS.kify(_isLower, 1);
var isUpper = LINKS.kify(_isUpper, 1);
var isDigit = LINKS.kify(_isDigit, 1);
var isXDigit= LINKS.kify(_isXDigit, 1);
var isBlank = LINKS.kify(_isBlank, 1);
