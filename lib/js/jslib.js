...
//           f.environment = _obj[i].environment;
         ...
         */
           ...
           _obj[i] = { clientPid : _lookupMobilePid(state, _obj[i]._clientPid), clientId = _obj[i]._clientId };
...
function _is_valid_client_pid(pid) {
  return (typeof o._clientId !== "undefined") && (typeof o._clientPid !== "undefined");
}

function _is_valid_server_pid(pid) {
  return (typeof o._serverPid !== "undefined");
}
...
//  _dump(_mailboxes)
  ...
  valid_server_pid = _is_valid_server_pid(pid);
  valid_client_pid = _is_valid_client_pid(pid);
  DEBUG.assert(valid_server_pid(pid) || valid_client_pid(pid),
