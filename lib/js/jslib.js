...
function deliverSessionMessage(epid, v) {
  ...
  if (!(epid in _buffers)) {
    if (epid in _delegating_endpoints) {
...
function handleGetLostMessages(remote_ep, ep_ids) {
  ...
  WEBSOCKET.send_lost_message_response(remote_ep, ret);
}
