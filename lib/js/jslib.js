...
var LINKS = function() {
  ...
  var _remoteContinue = function (_kappa, _continuation, _mailbox,
    ...
    LINKS.closureTable = _closureTable;
  ...
  var _remoteCallHandler = function (kappa, request, synch) {
    return function() {
      if (request.readyState == AJAX.isComplete && !request.finished) {
       ...
       resolveFunctions(x, LINKS.closureTable);
       ...
       if ((serverResponse instanceof Object)
          ...
          { var _closureTable = LINKS.closureTable;
          ...
          _invokeClientCall(kappa, serverResponse, LINKS.closureTable, synch);
...
var stringifyB64 = JSON.stringifyB64;
