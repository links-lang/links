...
const _$List = (function(){
  return Object.freeze({
    ...
    Cons: function(x,xs) {_$Debug.assert(_$List.isLinkedList(xs), "Second argument must be linked list"); return {_head: x, _tail: xs}},
    ...
    equal: function(l,r) {
      let curL = l;
      let curR = r;
      while(!_$List.isNil(curL) && !_$List.isNil(curR)) {
        if (!_$Links.eq(curL._head, curR._head)) return false;
        curL = curL._tail;
        curR = curR._tail;

      }
      return _$List.isNil(curL) && _$List.isNil(curR)
    },
    head: function(v) {
      _$Debug.assert(_$Types.isLinkedList(v), "Not a linked list");
    ...
    append: function(xs, ys) {
      _$Debug.assert(_$Types.isLinkedList(xs) && _$Types.isLinkedList(ys), "Not linked lists");
      if (_$List.isNil(xs)) {
        return ys;
      }
      const origxs = xs;
...
const _$Types = {
  ...
  isLinkedList: _$List.isLinkedList,
  ...
  getType: function (val) {
    ...
    else if (_$Types.isLinkedList (val))  return 'linkedlist';
...
const _$Links = new (function() {
  ...
  const _$Links = {
    ...
    */
    XmlToDomNodes : function (xmlForest) {
      _$Debug.assert(
        _$Types.isLinkedList(xmlForest),
    ...
    stringifyB64: function (v) { return _$Links.b64encode(_$Links.stringify(v)); },
  ...
  _$Links.eq = function(l, r) {
    ...
    if (_$Types.isLinkedList(l) && _$Types.isLinkedList(r)) return _$List.equal(l,r);
...
////   (perhaps move these into _$Links package)
...
// let _plus   = _$Links.kify(__plus);
// let _times  = _$Links.kify(__times);
// let _divide = _$Links.kify(__divide);
// let _minus  = _$Links.kify(__minus);
// let _hyphen = _minus;
// let _star   = _times;
// let _slash  = _divide;

// let _plus_fullstop   = _plus;
// let _hyphen_fullstop = _minus;
// let _star_fullstop   = _times;
// let _slash_fullstop  = _divide;
...
const stringifyB64 = _$Links.stringifyB64;
...
function _isXmlItem(obj) {
  ...
  if (obj.type === 'ELEMENT') {
    ...
    if(!_$Types.isLinkedList(obj.children)) {
      return false;
    }
...
function _isXml(obj) {
  if (!_$Types.isLinkedList(obj)) return false;
  let childrenOkay = true;
