...
val var : Types.FrontendTypeEnv.var_environment -> string -> (Types.type_arg list * Types.datatype)
val rigid : Types.FrontendTypeEnv.var_environment -> string -> (Types.type_arg list * Types.datatype)
...
val alias : string -> Types.type_arg list -> Types.FrontendTypeEnv.tycon_environment -> Types.datatype
