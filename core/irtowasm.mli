...
module Code: sig
  ...
  type t = Var     of Var.t
         ...
         | LitInt     of int
         | LitBool    of bool
         (** [Lit] denotes a literal, for now boolean or integer *)
         | Fn      of Var.t list * t
        ...
        (** [Nothing] denotes the empty code. It can be used to end a binding
         ...
         | Absurd
        (** [Absurd] denotes an expression which should never be reached. *)
