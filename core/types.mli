...
type lens_phrase =
  ...
  | `Var       of LensOperators.name
  | `InfixAppl of LensOperators.binop * lens_phrase * lens_phrase
  (* the In operator checks if the tuple generated by the names list is
   * in the list of constant tuples *)
  | `In        of LensOperators.name list * (Constant.constant list) list
  | `UnaryAppl of LensOperators.unary_op * lens_phrase
