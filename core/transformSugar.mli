...
object ('self)
  ...
  val tycon_env : Types.alias_environment
  val effect_row : Types.row

  method get_var_env     : unit -> Types.environment
  method get_tycon_env   : unit -> Types.alias_environment
  method get_formlet_env : unit -> Types.environment

  method backup_envs     :  Types.environment * Types.alias_environment * Types.environment * Types.row
  method restore_envs    : (Types.environment * Types.alias_environment * Types.environment * Types.row) -> 'self

  method with_var_env     : Types.environment -> 'self
  method with_formlet_env : Types.environment -> 'self

  method bind_alias      : string -> Types.tycon_spec -> 'self
