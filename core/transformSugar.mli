...
object ('self)
  ...
  method with_var_env     : FrontendTypeEnv.qual_var_environment -> 'self
  method with_module_env  : FrontendTypeEnv.qual_module_environment -> 'self
  method with_formlet_env : FrontendTypeEnv.qual_var_environment -> 'self
