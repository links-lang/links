...
val binary_of_sugartype_op : Operators.BinaryOp.t -> Lens.Operators.Binary.t option
...
val lens_sugar_phrase_of_sugar : Sugartypes.phrase -> Position.t Lens.Phrase.Sugar.phrase
