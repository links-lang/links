...
(* Like generalise, but does not mutate the generlized type variables by making them rigid.
  This means that the generlized type variables must be post-processed elsewhere! *)
