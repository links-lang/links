...
val project_type : ?overstep_quantifiers:bool -> Label.t -> Types.datatype -> Types.datatype
val erase_type   : ?overstep_quantifiers:bool -> Label.Set.t -> Types.datatype -> Types.datatype
val inject_type  : Label.t -> Types.datatype -> Types.datatype
...
val iter_row : (Label.t -> Types.field_spec -> unit) -> Types.row -> unit
val split_row : Label.t -> Types.row -> (Types.datatype * Types.row)
val split_variant_type : Label.t -> Types.datatype -> (Types.datatype * Types.datatype)
val variant_at : ?overstep_quantifiers:bool -> Label.t -> Types.datatype -> Types.datatype
...
val record_without : Types.datatype -> Label.Set.t -> Types.datatype

(* Session stuff *)
(* val session_of_type : Types.datatype -> Types.session_type *)
val select_type : Label.t -> Types.datatype -> Types.datatype
val split_choice_type : Label.t -> Types.datatype -> (Types.datatype * Types.datatype)
val choice_at : Label.t -> Types.datatype -> Types.datatype
...
val row_present_types : Types.datatype -> Types.datatype Label.Map.t
