...
class map =
  object ((o : 'self_type))
    ...
    method function_definition : function_definition -> function_definition
      ...
      let g = o#option (fun o -> o#datatype') g in
      { fun_binder = a;
        fun_linearity = b;
        fun_definition = (c, d);
        fun_location = e;
...
class fold_map =
  object ((o : 'self_type))
    ...
    method function_definition : function_definition -> 'self * function_definition
      ...
      let (o, _x_i5) = o#option (fun o -> o#datatype') _x_i5 in
      (o, { fun_binder = _x;
            fun_linearity = _x1;
            fun_definition = (_x_i1, _x_i2);
            fun_location = _x_i3;
