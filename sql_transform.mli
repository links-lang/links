...
val select : Query.expression list * Query.expression list -> Query.query -> Query.query
...
val join : Query.expression list * Query.expression list -> Query.query * Query.query -> (Query.column * string) list * Query.query
