...
The variable C<parlors> then has type 
C<TableHandle((name : String, fans : Int), (name : String, fans : Int))>.
The two arguments to the C<TableHandle> type constructor together
identify the type of a row and its constraints (See L<Table
constraints>).
